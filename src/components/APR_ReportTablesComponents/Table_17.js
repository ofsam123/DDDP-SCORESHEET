...
const Table_17 = ({ year, district, period }) => {
  ...
  return (
    <div className="col-12">
      <h3>Table 17 – Updates on Critical Development and Poverty Issues in the Year {year}</h3>
      <div className="card">
            ...
            <table className="table table-bordered"  style={{marginTop: '20px'}}>
              <thead style={{ backgroundColor: '#d4edda', fontWeight: 'bold', border: '1px solid #000',  }}>
                <tr>
                  ...
                  <th style={{ border: '1px solid #000', fontWeight: 'bold' }}>Number of Beneficiaries Actual</th>
