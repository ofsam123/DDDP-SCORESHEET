...
function ClientServiceCharter({
    ...
    return (
        <>
            <Title level={3} style={{ marginTop: "30px" }}>2.5 Availability of Client Service Charter</Title>
            ...
            <Content>
                <ol>
                    <li>EMA/CSC/V.1 (Hard copy of EMA Client Service Charter).</li>
                    <li>www.ejma.gov.gh</li>
                </ol>
            </Content>
        </>
    );
