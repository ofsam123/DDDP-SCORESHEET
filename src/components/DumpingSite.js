...
function DumpingSite({
    ...
    function getDumpingSite() {
        axios
            .get(`/tracker/trackedEntities?orgUnit=${district}&program=Txcfc03kUCi`)
            .then(result => {
                if (result.data.instances.length > 0) {

                    axios
                        .get(`/tracker/events?program=Txcfc03kUCi&orgUnit=${district}&startDate=${year}-01-01&endDate=${year}-12-31`)
                        .then(resp => {
