...
function TransportationNetworkService({
    ...
    const getIndicatorsData = () => {
        ...
        axios.get(`/analytics.json?dimension=dx:E8M6EnQ2uKe&dimension=ou:LEVEL-3;${district}&filter=pe:${year}-01-01;${year}-12-31`)
            .then(res => {
